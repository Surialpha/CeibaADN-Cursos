...
public class DaoUsuarioMysql implements DaoUsuario {
    ...
    @SqlStatement(namespace="usuario", value="listarBy")
	...
	@Override
	public  List<DtoUsuario> listarById(Long id) {
		 MapSqlParameterSource paramSource = new MapSqlParameterSource();
	     paramSource.addValue("id", id);
	     return this.customNamedParameterJdbcTemplate.getNamedParameterJdbcTemplate().query( sqlListarBy ,paramSource ,new MapeoUsuario() );
	}
}
